function [dataOk, detObj, rp, rp_x, np, np_x QQ, idx_detected_object] = readAndParseData16XX(DATA_sphandle, ConfigParameters)
        ...
        for tlvIdx = 1:Header.numTLVs
            ...
            switch tlv.type
                ...
                case MMWDEMO_UART_MSG_RANGE_PROFILE
                    ...
                    rp_x = (0:((tlv.length)/2)-1) * ConfigParameters.rangeIdxToMeters;
                    (0:ConfigParameters.numRangeBins-1);
                    idx_detected_object=detObj.range/ConfigParameters.rangeIdxToMeters;
...
%                 }
                ...
                case MMWDEMO_UART_MSG_NOISE_PROFILE
                    ...
                    np = byteBuffer(idx+(1:tlv.length));
                    
                    idx = idx + tlv.length;
                    np=np(1:2:end)+np(2:2:end)*256;
                    np_x = (0:((tlv.length)/2)-1) * ConfigParameters.rangeIdxToMeters;
                    (0:ConfigParameters.numRangeBins-1);
